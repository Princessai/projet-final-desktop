...
function Timetable({ TimetableData, border = 10, height = 600, timeScaleWidth = '10%' }) {
    ...
    for (let dayCount = 0; dayCount <= maxDay;) {
        ...
        timetableDays.push(
            <div key={dayCount} style={{ flexGrow: 1}}>
    ...
    for (let hoursSteps = dayStartHour; hoursSteps < dayEndHour;) {
        ...
        for (let dayCount = 0; dayCount <= maxDay;) {
            ...
            if (findedSeance) {
                ...
                if ((prevSeancesEnd[dayCount] == currentLine) && rowspan < 1) {
                    const leftTdOffset = tdWidth * dayCount + timeScaleWidth + "%"
        ...
        timeTableBody.push(<div className='tr' style={{ height: rowHeight + 'px' }} key={hoursSteps}>
            ...
            < div className="timeScaleElemntContainer h-100 " key={hoursSteps} style={{ left: `-${borderWidth / 2}px`, width: timeScaleWidthUnit }}>
                <span className='timeScaleElemnt'>  {formatTime.format('HH:mm')} </span>
                {currentSpecificTimeScale}
    ...
    return (
        ...
        <div>
            ...
            <div className='timetableHeader d-flex' >
                <div className='TimeTableTimeScale text-center' style={{ minWidth: timeScaleWidthUnit }}>
                    Hours
                </div>
