...
const router = createHashRouter([
  ...
  {
    path: "/parent/child/profil/:user_id",
    element: (
      <ProtectedRoute>
        <ChildProfilePage />
      </ProtectedRoute>
  ...
  {
    path: "/parent/child/timetable/:classe_id/:classe_label",
    element: (
      <ProtectedRoute>
        <ChildTimetable />
      </ProtectedRoute>
...

  {
    ...
    element: (
      <ProtectedRoute>
        <CoordinatorTimetable />
      </ProtectedRoute>
    ), // home coordinator
  },
  {
    path:
      routeRegister.getRoute("coordinatorTimetableClass") +
      "/:classe_id/:classe_label",
    element: (
      <ProtectedRoute>
        <CoordinatorTimetableClass />
      </ProtectedRoute>
    ),
  },
  {
  ...
  {
    path:
      routeRegister.getRoute("coordinatorUserClass") +
      "/:classe_id/:classe_label",
    element: (
      <ProtectedRoute>
        <CoordinatorUserClass />
      </ProtectedRoute>
    ),
  },
  {
  ...
  {
    path:
      routeRegister.getRoute("coordinatorCallSession") +
      "/:mode/:seance_id/:seance_classe/:heure_debut/:heure_fin",
    element: (
      <ProtectedRoute>
        <CoordinatorCallSession />
      </ProtectedRoute>
    ),
  },
  {
  ...
  {
    path:
      routeRegister.getRoute("coordinatorClassesInfos") +
      "/:classe_id/:classe_label",
    element: (
      <ProtectedRoute>
        <ClasseInfos />
  ...
  {
    path:
      routeRegister.getRoute("coordinatorClassesModules") +
      "/:classe_id/:classe_label",
    element: (
      <ProtectedRoute>
        <Modules />
